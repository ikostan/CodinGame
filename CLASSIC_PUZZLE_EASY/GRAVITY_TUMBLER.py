...
GRAVITY TUMBLER
Source: https://www.codingame.com/training/easy/gravity-tumbler
...
(This puzzle is a twist (hah!) on classic community puzzle “Gravity”.
You may want to solve that one first.)
